#!/bin/sh
# Regenerate notes/INDEX.md from the notes' own headings.
# Run after editing any note; line numbers in the index are what make
# targeted reads (sed -n 'A,Bp') possible, and they rot on every edit.
set -e
cd "$(dirname "$0")/.."
...
# Preserve the hand-kept symbol map across regenerations.
